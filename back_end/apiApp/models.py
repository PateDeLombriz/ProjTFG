...
class DocumentObra(models.Model):
    ...
    mida = models.DecimalField(max_digits=65535, decimal_places=65535)
...
class Recurs(models.Model):
    ...
    quantitat_stock = models.DecimalField(max_digits=65535, decimal_places=65535)
...
class UEmpresa(models.Model):
    id = models.OneToOneField('Usuari', models.DO_NOTHING, db_column='id', primary_key=True)
...
class Usuari(models.Model):
    id= models.AutoField(db_column='Id', primary_key=True)  # Field name made lowercase
    tipus = models.TextField()  # This field type is a guess.
    nom = models.CharField(max_length=120)

...
For more information on this file, seeFlogg
...
DATABASES = { #Perque funcioni amb postgresd
    'default': {
        'ENGINE': os.getenv("DATABASE_ENGINE", 'django.db.backends.postgresql'), #Alomillor fall, si falla deixan nomes postgtres.
...
#LOGGING = {# Mostrar interacciond de django amb postgresql, per veure les queries SQL que fa
 #   'version': 1,
 #   'loggers': {
 #       'django.db.backends': {
 #           'handlers': ['console'],
 #           'level': 'DEBUG',   # MOSTRA SQL!
 #       },
 #   },
#}

...
/* ─────────────────────────
   ...
   ───────────────────────── */
INSERT INTO empresa
(id_empresa, nom_empresa, cif, ubicacio_id, telefon, email, web, sector, data_alta, estat, persona_contacte, num_empleats, comentaris) VALUES
  (1, 'Construccions Alzina', 'B00000004', 7, '871123456', 'info@alzina.com', NULL, NULL, '2024-05-21', 'activa', NULL, NULL, NULL),
  (2, 'Serveis Integrals',    'B00000005', 8, '971987654', 'contacte@servintmallorca.com', NULL, NULL, '2024-05-25', 'activa', NULL, NULL, NULL);

/* ───────────────────────────
   TREBALLADOR (abans u_persona)
   ─────────────────────────── */
INSERT INTO treballador
(id, nom, cognoms, nickname, dni_nie_passaport, data_naixement, telefon, email, foto, comentaris) VALUES
  (1, 'Joan',  'Garcia Mora', 'JohanPaletas', 'DNI0001A', NULL, '600123001', NULL, NULL, 'rol=Mestre Obra; estat=ACTIU'),
